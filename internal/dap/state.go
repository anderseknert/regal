...
func (s *state) evaluate(r *godap.EvaluateRequest) (*godap.EvaluateResponse, error) {
	// {
	//   "expression": "x = 1",
	//   "frameId": 12,
	//   "context": "repl"
	// }
	return evalInFrame(s.session, debug.FrameID(r.Arguments.FrameId), r.Arguments.Expression)
}
